...
<div class="row row-cols-4 row-cols-md-5 g-3 mx-5 my-3">
    <c:forEach var="menuItem" items="${sessionScope.menuItems}">
        <div class="col">
            <div class="card bg-light">
                <div class="p-3">
                    <img style="user-select: none" src="data:image/png;base64,${menuItem.pictureBase64}" class="card-img-top"
                         alt="${menuItem.name}">
                </div>
                    ...
                    <li class="list-group-item p-0">
                        <form class="m-0" action="${pageContext.request.contextPath}/controller" method="post">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="number" name="menu-item-count" value="1" min="1"
                                       step="1" required>
                                    <input class="btn btn-outline-primary text-wrap" type="submit" name="submit-button"
